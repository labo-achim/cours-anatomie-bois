...
\title{Anatomie du bois -- GBO-4000 / GBO-7000}
...
\input{0.avant_propos}
\input{1.notions_generales}
\input{2.desc_macro}
\input{3.desc_micro_resineux}
\input{4.desc_micro_feuillus}
\input{5.croissance}
\input{6.paroi_cellulaire}
\input{7.variabilite}
\input{8.qualite}
\input{9.irregularite}
%\input{10.systeme_forestier}
